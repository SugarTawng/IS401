import { B as BaseStyle, U as UniqueComponentId, Z as ZIndexUtils, D as DomHandler, R as Ripple, p as FocusTrap } from './server.mjs';
import { s as script$5 } from './index.esm-CbKY_bSB.mjs';
import { s as script$6 } from './baseicon.esm-DbzTeshI.mjs';
import { computed, openBlock, createElementBlock, mergeProps, resolveComponent, resolveDirective, createBlock, withCtx, createVNode, Transition, withDirectives, renderSlot, Fragment, normalizeClass, toDisplayString, createCommentVNode, createElementVNode, resolveDynamicComponent, createTextVNode } from 'vue';
import { s as script$4 } from './portal.esm-CdWWxjdD.mjs';
import { s as script$7 } from './basecomponent.esm-DXWDIfdj.mjs';
import '../runtime.mjs';
import 'node:http';
import 'node:https';
import 'fs';
...
//# sourceMappingURL=dialog.esm-Wemb0g_v.mjs.map
