...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/devalue/index.js';
import destr from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/ufo/dist/index.mjs';
import { hash } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/errx/dist/index.js';
import * as vue$1 from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/vue/index.mjs';
import { isVNode, version, unref } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/vue/index.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/pathe/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/admin/Desktop/real-estate-management/frontend/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "C:/Users/admin/Desktop/real-estate-management/frontend/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/admin/Desktop/real-estate-management/frontend/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\admin\\Desktop\\real-estate-management\\frontend","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\admin\\Desktop\\real-estate-management\\frontend\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\admin\\Desktop\\real-estate-management\\frontend\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\admin\\Desktop\\real-estate-management\\frontend\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\admin\\Desktop\\real-estate-management\\frontend\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const rootDir = "C:/Users/admin/Desktop/real-estate-management/frontend";
...
function _toPrimitive$1$1(t, r) { if ("object" != _typeof$2(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r); if ("object" != _typeof$2(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return (String )(t); }
...
const _U4DrQ5H2cR = defineNitroPlugin(async (nitroApp) => {
...
const _VvvC10 = lazyEventHandler(() => {
...
const _lazy_VdpQWu = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_VdpQWu, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _VvvC10, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_VdpQWu, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1.0"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/public/images/favicon.ico"}],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1.0","title":"Propertier"};
...
const getClientManifest = () => import('file://C:/Users/admin/Desktop/real-estate-management/frontend/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
