...
CREATE TABLE `tbl_land_list_owner` (
  ...
  KEY `fk_landlistowner_project_idx` (`project_id`),
  ...
  CONSTRAINT `fk_landlistowner_project` FOREIGN KEY (`project_id`) REFERENCES `tbl_project` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2024-07-28 14:21:20
